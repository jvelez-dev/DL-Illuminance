# -*- coding: utf-8 -*-
"""
Created on Thu Jul  7 17:25:14 2022
...
EPOCHS = 1000
CARPETA = 'C:/Users/JVelez/TF_MLP/CNNS-EHEV-ASIM/modelos/'
IV_ENTRENAMIENTO=''
IV_VALIDACION=''
IV_EVALUACION=''
IV_PREDICCION=''
...
def cargar_conjunto(conjunto):
    ...
    df.columns=['Foco1X','Foco1Y','Foco1Z','Foco1I','Foco2X','Foco2Y','Foco2Z','Foco2I','PuntoX','PuntoY','PuntoZ','Distancia','EH','EV','PuntoI']
...
def generacion_cubo_predicciones(dataset,nombre_archivo,nuevo_modelo):  
    ...
    np.savetxt("C:/Users/JVelez/TF_MLP/CNNS-EHEV-ASIM/modelos/cubo_predicciones_{}.csv".format(nombre_archivo),df_result,delimiter=';',fmt='%f')
    
def cargar_modelo(model_folder,model_name):
    nuevo_modelo = keras.models.load_model('C:/Users/JVelez/TF_MLP/CNNS-EHEV-ASIM/modelos/{}/{}.h5'.format(model_folder,model_name)) 
    return nuevo_modelo   
...
#generar_modelos()
def generar_RMSPE():
    modelo = cargar_modelo('metricas_modelo_8','modelo_8')
    X,Y = cargar_conjunto('dataset_VL_11_2Focos')   
