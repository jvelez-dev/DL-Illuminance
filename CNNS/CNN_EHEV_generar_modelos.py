...
EPOCHS = 1000
CARPETA = 'C:/Users/JVelez/TF_MLP/CNNS-EHVH/modelos/'
IV_ENTRENAMIENTO=''
IV_VALIDACION=''
IV_EVALUACION=''
IV_PREDICCION=''
...
def cargar_modelo(model_folder,model_name):
    nuevo_modelo = keras.models.load_model('C:/Users/JVelez/TF_MLP/CNNS-EHVH/modelos/{}/{}.h5'.format(model_folder,model_name)) 
    return nuevo_modelo
