# -*- coding: utf-8 -*-
"""
Created on Thu Jul  7 17:11:40 2022
...
EPOCHS = 1000
CARPETA = 'C:/Users/JVelez/TF_MLP/CNNS-ASIM/modelos/'
IV_ENTRENAMIENTO=''
IV_VALIDACION=''
IV_EVALUACION=''
IV_PREDICCION=''
...
def generacion_cubo_predicciones(dataset,nombre_archivo,nuevo_modelo):  
    ...
    np.savetxt("C:/Users/JVelez/TF_MLP/CNNS-ASIM/modelos/cubo_predicciones_{}.csv".format(nombre_archivo),df_result,delimiter=';',fmt='%f')
    
def cargar_modelo(model_folder,model_name):
    nuevo_modelo = keras.models.load_model('C:/Users/JVelez/TF_MLP/CNNS-ASIM/modelos/{}/{}.h5'.format(model_folder,model_name)) 
    return nuevo_modelo   
...
#generar_modelos()
def generar_RMSPE():
    modelo = cargar_modelo('metricas_modelo_7','modelo_7')
    X,Y = cargar_conjunto('dataset_VL_11_2Focos')   
