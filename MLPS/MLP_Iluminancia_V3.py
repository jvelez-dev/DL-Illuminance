# -*- coding: utf-8 -*-
"""
Created on Thu Feb  3 14:59:02 2022
TOMAR EL MODELO 7{
    * Escala logarítmica
    * 30 Neuronas
    * 1 capa oculta
...
EPOCHS = 5000
PACIENCIA = 80
CARPETA = 'C:/Users/JVelez/TF_MLP/modelos/Version4/'
IV_ENTRENAMIENTO=''
IV_VALIDACION=''
IV_EVALUACION=''
IV_PREDICCION=''
...
def cargar_modelo(model_name):
    nuevo_modelo = keras.models.load_model('C:/Users/JVelez/TF_MLP/modelos/Version4/{}/{}.h5'.format(model_name,model_name)) 
    return nuevo_modelo   
...
def guardar_metricas(model,model_id,history):
    ...
    metrics = ['mse', 'root_mean_squared_error', 'mae', 'val_mse', 'val_root_mean_squared_error', 'val_mae']    
    for m in metrics:
...
def registrar_reporte(model_id,history,eval_score,predict_score,tiempo):
    ...
    metrics_entrenamiento = ['mse', 'root_mean_squared_error', 'mae']   
    metrics_validacion = ['val_mse', 'val_root_mean_squared_error', 'val_mae']       
    ...
    with open('./modelos/Version4/reporte.csv', 'a') as f_object:
...
modelo = cargar_modelo("modelo_52")
